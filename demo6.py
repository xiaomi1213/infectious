...
# 在demo5基础上，因为用交互模式不好保存，所以重新改回animation模式
...
if __name__ == "__main__":
    ...
    ani = animation.FuncAnimation(fig, animate, frames, init_func=init, repeat_delay=1, cache_frame_data=False )

    ani.save("pp.gif", writer='pillow')
